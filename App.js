...
function RootNavigator() {
  ...
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="MyApplications"  component={MyApplicationsScreen}  options={{ headerShown: true, headerTitle: t('myApplications'),  ...HEADER }} />
      <Stack.Screen name="SeekerProfile"   component={SeekerProfileScreen}   options={{ headerShown: true, headerTitle: t('mySeekerProfile'), ...HEADER }} />
      <Stack.Screen name="Analytics"       component={AnalyticsScreen}       options={{ headerShown: true, headerTitle: t('analytics'),       ...HEADER }} />
      <Stack.Screen name="Alerts"          component={AlertsScreen}          options={{ headerShown: true, headerTitle: t('jobAlerts'),       ...HEADER }} />
      <Stack.Screen name="ChatList"        component={ChatListScreen}        options={{ headerShown: true, headerTitle: t('messages'),        ...HEADER }} />
      <Stack.Screen name="Chat"            component={ChatScreen}            options={{ headerShown: true, headerTitle: t('chat'),            ...HEADER }} />
    </Stack.Navigator>
  );
}
