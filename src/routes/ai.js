...
// POST /api/ai/chat
// Proxies the request to Anthropic — the API key stays on the server.
// Rate limiting is applied at the router level in index.js (10 req/min).
router.post('/chat', auth, async (req, res) => {
  ...
  try {
    ...
    // FIX #17 — do not forward internal error details
