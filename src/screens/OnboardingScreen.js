...
const SLIDES = [
  {
    ...
    subHi: 'नांदेड में सैकड़ों नौकरियाँ — ड्राइवर, सुरक्षा, दुकान सहायक और बहुत कुछ। पूरी तरह मुफ़्त।',
  },
  {
    ...
    subHi: 'कमरा किराए पर लें, कार किराए पर दें, या पुराना सामान खरीदें-बेचें — नांदेड के लिए एक ही ऐप।',
  },
  {
    ...
    subHi: 'नियोक्ता सिर्फ ₹49 में नौकरी पोस्ट करें। अधिक लोगों तक पहुँचने के लिए बूस्ट करें।',
  },
];
  ...
  return (
    <View style={os.slide}>
      ...
      <Animated.View style={{ opacity: textOpacity, transform: [{ translateY: textY }] }}>
        <Text style={os.title}>{isMr ? slide.titleMr : isHi ? slide.titleHi : slide.title}</Text>
        <Text style={os.sub}>{isMr ? slide.subMr : isHi ? slide.subHi : slide.sub}</Text>
      </Animated.View>
    </View>
  );
}
  ...
  return (
    <View style={os.root}>
      ...
      <View style={os.langRow}>
        {LANGUAGES.map(l => (
          <TouchableOpacity key={l.code} style={[os.langBtn, lang === l.code && os.langActive]} onPress={() => setLang(l.code)}>
            <Text style={[os.langTxt, lang === l.code && os.langActiveTxt]}>{l.native}</Text>
          </TouchableOpacity>
        ))}
      </View>
      ...
      <View style={os.btnRow}>
        <TouchableOpacity style={os.skipBtn} onPress={finish}>
          <Text style={os.skipTxt}>
            {lang === 'mr' ? 'वगळा' : lang === 'hi' ? 'छोड़ें' : 'Skip'}
          </Text>
        </TouchableOpacity>
