...
export default function AlertsScreen() {
  ...
  useEffect(() => {
    ...
    const greeting = `Hi ${name}! 👋 I'm your CityPlus AI assistant. There are ${activeJobs.length} active listings on the platform right now. Ask me anything — jobs, salaries, descriptions, market tips.`;
