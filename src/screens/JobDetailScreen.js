    ...
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 16, paddingBottom: 40 }}>
      ...
      <Card style={{ marginBottom: 12 }}>
        <View style={styles.statsRow}>
          ...
          <View style={styles.statBox}>
            <Text style={[styles.statNum, { color: ORANGE }]}>{applicants}</Text>
            <Text style={styles.statLbl}>Applied</Text>
          </View>
          <View style={styles.statDivider} />
          <View style={styles.statBox}>
            <Text style={[styles.statNum, { color: isNew ? '#16a34a' : '#bbb' }]}>{isNew ? 'NEW' : `${Math.floor(ageDays)}d`}</Text>
            <Text style={styles.statLbl}>{isNew ? 'Just posted' : 'Old'}</Text>
          </View>
        </View>
      </Card>
        ...
        <Card style={{ marginBottom: 12 }}>
          ...
          <View style={styles.contactBtns}>
            ...
            <TouchableOpacity style={styles.waBtn} onPress={whatsapp}>
              ...
              <Text style={styles.callBtnTxt}>WhatsApp</Text>
            </TouchableOpacity>
          </View>
        </Card>
      )}
      ...
      <Card style={{ marginBottom: 12 }}>
        ...
        {!isOwner && (
          <Btn label="Mark as Applied" onPress={applyJob} style={{ marginTop: 12 }} />
        )}
        {isOwner && (
          <Btn label="Delete Job" variant="danger" onPress={deleteJob} style={{ marginTop: 12 }} />
        )}
      </Card>
...
const styles = StyleSheet.create({
  ...
  callBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: ORANGE, borderRadius: 10, paddingVertical: 12 },
  waBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: '#25d366', borderRadius: 10, paddingVertical: 12 },
  callBtnTxt: { color: '#fff', fontWeight: '700', fontSize: 14 },
