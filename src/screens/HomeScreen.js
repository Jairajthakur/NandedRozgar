    ...
    <AnimatedPress style={[s.featJobCard, IS_WEB && ws.featJobCard, IS_WEB && fullWidth && ws.featJobCardSmWeb]} onPress={onPress}>
      ...
      <View style={s.featJobBottom}>
        ...
        <TouchableOpacity style={s.applyBtn} onPress={onPress} activeOpacity={0.85}>
          <Text style={s.applyBtnTxt}>{t('apply')}</Text>
        </TouchableOpacity>
      </View>
    </AnimatedPress>
  );
      ...
      <View style={[s.roomImgPlaceholder, IS_WEB && ws.roomImgPlaceholder]}>
        ...
        {available && (
          <View style={s.availBadge}>
            <Text style={s.availTxt}>{t('available')}</Text>
          </View>
        )}
      </View>
      ...
      <View style={ws.root}>
        ...
        <View style={ws.topNav}>
          <View style={[ws.topNavInner, isSmWeb && ws.topNavInnerSm]}>
            {!isSmWeb && <TouchableOpacity style={ws.brandRow} onPress={() => nav.navigate('Home')} activeOpacity={0.8}>
