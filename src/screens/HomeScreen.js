...
export default function HomeScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#111' }}>
      ...
      <View style={[s.headerBand, { paddingTop: insets.top + 8 }]}>
              ...
              <AnimatedPress style={{ flex: 1 }} onPress={() => nav.navigate('Jobs')}>
                <View style={[s.featuredCard, { flex: 1 }]}>
                  ...
                  <View style={s.featuredContent}>
                    ...
                    <Text style={s.featuredSub}>{activeJobs.length || 842}+ {t('opening')}</Text>
                  </View>
                </View>
              </AnimatedPress>
              <View style={s.gridRightCol}>
                <AnimatedPress style={{ flex: 1 }} onPress={() => nav.navigate('Cars')}>
                  <View style={[s.smallCard, { flex: 1, backgroundColor: '#e8f4ff' }]}>
                    <View style={s.smallCardInner}>
                      <View><Text style={s.smallCardTitle}>{t('carRental')}</Text><Text style={s.smallCardSub}>{carCount || 156} {t('vehicles')}</Text></View>
                      <View style={[s.smallCardIcon, { backgroundColor: '#fff' }]}><Ionicons name="car-sport" size={20} color="#3b82f6" /></View>
                    </View>
                  </View>
                </AnimatedPress>
                <AnimatedPress style={{ flex: 1 }} onPress={() => nav.navigate('Rooms')}>
                  <View style={[s.smallCard, { flex: 1, backgroundColor: '#f0f0ff' }]}>
                    <View style={s.smallCardInner}>
                      <View><Text style={s.smallCardTitle}>{t('roomsPG')}</Text><Text style={s.smallCardSub}>{roomCount || 324} {t('listings')}</Text></View>
                      <View style={[s.smallCardIcon, { backgroundColor: '#fff' }]}><Ionicons name="business" size={20} color="#6366f1" /></View>
                    </View>
                  </View>
                </AnimatedPress>
              </View>
...
const s = StyleSheet.create({
  ...
  heroBanner: { backgroundColor: ORANGE, paddingHorizontal: 20, paddingTop: 24, paddingBottom: 20, borderBottomLeftRadius: 0, borderBottomRightRadius: 0, marginBottom: 4, shadowColor: ORANGE, shadowOpacity: 0.4, shadowRadius: 16, shadowOffset: { width: 0, height: 6 }, elevation: 8 },
  ...
  headerBand: { backgroundColor: '#111111', paddingHorizontal: 16, paddingBottom: 14 },
  ...
  locText: { color: '#aaaaaa', fontSize: 12, fontWeight: '500' },
  ...
  langToggle: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: '#1e1e1e', borderRadius: 20, paddingVertical: 5, paddingHorizontal: 12, borderWidth: 1, borderColor: '#f97316' },
