...
export const ROOMS = [
  {
    id: 'r1',
    title: '1 BHK Flat Available – Vazirabad',
    location: 'Vazirabad, Nanded',
    type: '1BHK',
    rent: '₹5,500/mo',
    rentNum: 5500,
    available: true,
    description: 'Semi-furnished 1BHK on 2nd floor. Spacious hall, attached kitchen, western toilet. Water supply twice daily. Very close to Vazirabad bus stand. Society has 24/7 watchman. Immediate possession possible. No brokerage.',
    amenities: ['Parking', 'Power Backup', '24/7 Security', 'Water 24/7'],
    for: 'Any',
    listedDaysAgo: 1,
    deposit: '2 months',
  ...
  {
    id: 'r2',
    title: 'Girls PG – Near SRTMU University',
    location: 'Vishnupuri, Nanded',
    type: 'PG',
    rent: '₹4,500/mo',
    rentNum: 4500,
    available: true,
    description: 'Safe & secure girls PG with AC rooms. 3 home-cooked meals daily included. Attached bathroom. Study table & cupboard in every room. CCTV on all floors. 5 mins walk from SRTMU main gate. Strict 10 PM entry. Caretaker madam always present.',
    amenities: ['AC', 'Meals', 'WiFi', 'CCTV', '24/7 Security'],
    for: 'Female',
    listedDaysAgo: 2,
    deposit: '1 month',
  ...
  {
    id: 'r3',
    title: 'Furnished Single Room – Station Road',
    location: 'Station Road, Nanded',
    type: 'Single Room',
    rent: '₹2,800/mo',
    rentNum: 2800,
    available: true,
    description: 'Fully furnished single room with bed, table, fan & almirah. Shared kitchen and bathroom (clean, 2 sharing only). 3 mins walk from Nanded Railway Station. Electricity on meter. Ground floor, easy access. Ideal for railway or bank employees.',
  ...
  {
    id: 'r4',
    title: '2 BHK Family Flat – Shivajinagar',
    location: 'Shivajinagar, Nanded',
    type: '2BHK',
    rent: '₹8,500/mo',
    rentNum: 8500,
    available: true,
    description: '2BHK on 3rd floor with lift. Modular kitchen, two full bathrooms, 2 balconies. Society with children park & security cabin. Covered parking for 1 car. Water tanker backup. 10 mins from MGM Hospital. Preferred: small family or working couple.',
    amenities: ['Lift', 'Parking', 'Power Backup', 'Water 24/7', '24/7 Security'],
    for: 'Any',
    listedDaysAgo: 4,
    deposit: '2 months',
    owner: { name: 'Anil Patil', verified: true },
    phone: '9898989898',
    photos: [
      ...
      'https://images.unsplash.com/photo-1565182999561-18d7dc61c393?w=800&q=85',
    ],
  },
  {
    id: 'r5',
    title: 'Boys PG with Meals – CIDCO',
    location: 'CIDCO Colony, Nanded',
    type: 'PG',
    rent: '₹3,800/mo',
    rentNum: 3800,
    available: true,
    description: 'Spacious PG for working males & students. Double sharing rooms, each with attached bathroom. Breakfast + dinner included. Washing machine facility. Very close to CIDCO main bus stop. Rent includes electricity up to 100 units. No advance above 1 month.',
    amenities: ['Meals', 'WiFi', 'Parking', 'Power Backup'],
    for: 'Male',
    listedDaysAgo: 5,
    deposit: '1 month',
    owner: { name: 'Deepak Jadhav', verified: true },
    phone: '9911223344',
    photos: [
  ...
  {
    id: 'r6',
    title: '1 BHK – Guru Nanak Nagar, Ready to Move',
    location: 'Guru Nanak Nagar, Nanded',
    type: '1BHK',
    rent: '₹6,000/mo',
    rentNum: 6000,
    available: true,
    description: 'Newly painted 1BHK with modular kitchen and concealed wiring. First floor, east-facing. Independent meter. Society maintenance ₹300/mo extra. 5 mins from Nanded City Mall. Peaceful residential area. Suitable for couples or small families. Owner stays in same building.',
    amenities: ['Parking', 'Water 24/7', 'Power Backup'],
    for: 'Any',
    listedDaysAgo: 6,
    deposit: '2 months',
    owner: { name: 'Meena Shinde', verified: true },
    phone: '9823456780',
    photos: [
      'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800&q=85',
      'https://images.unsplash.com/photo-1574362848149-11496d93a7c7?w=800&q=85',
      'https://images.unsplash.com/photo-1599427303058-f04cbcf4756f?w=800&q=85',
    ],
  },
  {
    id: 'r7',
    title: 'Single Room for Girls – Naigaon Road',
    location: 'Naigaon, Nanded',
    type: 'Single Room',
    rent: '₹3,200/mo',
    rentNum: 3200,
    available: true,
    description: 'Clean attached room with bathroom & small kitchenette. AC optional at ₹500 extra. RO water purifier in common area. 2 mins from Naigaon auto stand. Ground floor in independent house – landlady lives on 1st floor. Only serious working women apply please.',
    amenities: ['AC', 'WiFi', 'Water 24/7'],
    for: 'Female',
    listedDaysAgo: 7,
    deposit: '1 month',
    owner: { name: 'Lalita Gaikwad', verified: false },
    phone: '9856001234',
    photos: [
      'https://images.unsplash.com/photo-1616594039964-ae9021a400a0?w=800&q=85',
      'https://images.unsplash.com/photo-1564540574859-0dfb63985953?w=800&q=85',
    ],
  },
  {
    id: 'r8',
    title: '2 BHK Flat – Aurangabad Road, Near Petrol Pump',
    location: 'Aurangabad Road, Nanded',
    type: '2BHK',
    rent: '₹7,000/mo',
    rentNum: 7000,
    available: false,
    description: '2BHK semi-furnished flat on 2nd floor. Two halls, large kitchen with granite platform. Two bathrooms. Covered balcony. Corner flat so good light & ventilation. Bus stop just 1 min away. Electricity separate. Prefer government employees or teachers. Brokerage free – direct owner.',
    amenities: ['Parking', 'Power Backup', '24/7 Security'],
    for: 'Any',
    listedDaysAgo: 10,
    deposit: '2 months',
    owner: { name: 'Vinayak Bhosle', verified: false },
    phone: '9900112233',
    photos: [
  ...
  {
    id: 'r9',
    title: 'PG for Boys – Near Engineering College, Nanded',
    location: 'Vishnupuri, Nanded',
    type: 'PG',
    rent: '₹3,500/mo',
    rentNum: 3500,
    available: true,
    description: 'Budget PG perfect for engineering & polytechnic students. Triple sharing with lockers. 2 meals (lunch + dinner) included. 24/7 high-speed WiFi. Mess has Maharashtrian + North Indian menu. Walking distance from SGGS & MGM engineering colleges. Warden always available.',
    amenities: ['Meals', 'WiFi', 'Power Backup', '24/7 Security'],
    for: 'Male',
    listedDaysAgo: 2,
    deposit: '1 month',
    owner: { name: 'Santosh Kamble', verified: true },
    phone: '9977665544',
    photos: [
  ...
  {
    id: 'r10',
    title: 'Spacious 1 BHK – Ganesh Colony, Opposite Hanuman Mandir',
    location: 'Ganesh Colony, Nanded',
    type: '1BHK',
    rent: '₹4,800/mo',
    rentNum: 4800,
    available: true,
    description: 'Good 1BHK on ground floor (no climbing stairs!). Hall with TV unit, kitchen with chimney, full bathroom with geyser. Very peaceful locality. Ample sunlight. Society has park. 7 mins auto ride to Nanded railway station. Available from 1st of next month. Genuine enquiries only.',
    amenities: ['Parking', 'Water 24/7', 'Power Backup', 'WiFi'],
    for: 'Any',
    listedDaysAgo: 1,
    deposit: '2 months',
    owner: { name: 'Priya Mukadam', verified: true },
    phone: '9812001122',
    photos: [
