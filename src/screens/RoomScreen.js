...
const SORT_OPTION_KEYS = [
  ...
  { key: 'lowestRent',  value: 'rentAsc' },
  { key: 'highestRent', value: 'rentDesc' },
];
  ...
  return (
    <View style={s.trendingBanner}>
      ...
      <View style={{ flex: 1 }}>
        ...
        <Text style={s.trendingSub}>{t('trendingRoomsTagline')}</Text>
      </View>
    ...
    <Modal visible={showSort} transparent animationType="fade" onRequestClose={() => setShowSort(false)}>
      ...
      <View style={[s.sheet, IS_WEB && ws.centeredModal]}>
        ...
        {SORT_OPTION_KEYS.map(opt => (
          ...
          >
            <Text style={[s.rangeTxt, sortBy === opt.value && { color: ORANGE, fontWeight: '700' }]}>{t(opt.key)}</Text>
            ...
            <View style={ws.rightSidebar}>
              ...
              <SideCard>
                ...
                {SORT_OPTION_KEYS.map(opt => (
                  ...
                  >
                    <Text style={[ws.sortTxt, sortBy === opt.value && ws.sortTxtActive]}>{t(opt.key)}</Text>
